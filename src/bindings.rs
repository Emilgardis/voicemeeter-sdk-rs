...
const _: () = {
    ["Size of tagVBVMR_AUDIOINFO"][::std::mem::size_of::<tagVBVMR_AUDIOINFO>() - 8usize];
    ["Alignment of tagVBVMR_AUDIOINFO"][::std::mem::align_of::<tagVBVMR_AUDIOINFO>() - 4usize];
    ["Offset of field: tagVBVMR_AUDIOINFO::samplerate"]
        [::std::mem::offset_of!(tagVBVMR_AUDIOINFO, samplerate) - 0usize];
    ["Offset of field: tagVBVMR_AUDIOINFO::nbSamplePerFrame"]
        [::std::mem::offset_of!(tagVBVMR_AUDIOINFO, nbSamplePerFrame) - 4usize];
};
#[doc = " @name VB-Audio Callback Functions\n @{"]
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of tagVBVMR_AUDIOBUFFER"][::std::mem::size_of::<tagVBVMR_AUDIOBUFFER>() - 2064usize];
    ["Alignment of tagVBVMR_AUDIOBUFFER"][::std::mem::align_of::<tagVBVMR_AUDIOBUFFER>() - 8usize];
    ["Offset of field: tagVBVMR_AUDIOBUFFER::audiobuffer_sr"]
        [::std::mem::offset_of!(tagVBVMR_AUDIOBUFFER, audiobuffer_sr) - 0usize];
    ["Offset of field: tagVBVMR_AUDIOBUFFER::audiobuffer_nbs"]
        [::std::mem::offset_of!(tagVBVMR_AUDIOBUFFER, audiobuffer_nbs) - 4usize];
    ["Offset of field: tagVBVMR_AUDIOBUFFER::audiobuffer_nbi"]
        [::std::mem::offset_of!(tagVBVMR_AUDIOBUFFER, audiobuffer_nbi) - 8usize];
    ["Offset of field: tagVBVMR_AUDIOBUFFER::audiobuffer_nbo"]
        [::std::mem::offset_of!(tagVBVMR_AUDIOBUFFER, audiobuffer_nbo) - 12usize];
    ["Offset of field: tagVBVMR_AUDIOBUFFER::audiobuffer_r"]
        [::std::mem::offset_of!(tagVBVMR_AUDIOBUFFER, audiobuffer_r) - 16usize];
    ["Offset of field: tagVBVMR_AUDIOBUFFER::audiobuffer_w"]
        [::std::mem::offset_of!(tagVBVMR_AUDIOBUFFER, audiobuffer_w) - 1040usize];
};
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of tagVBVMR_INTERFACE"][::std::mem::size_of::<tagVBVMR_INTERFACE>() - 232usize];
    ["Alignment of tagVBVMR_INTERFACE"][::std::mem::align_of::<tagVBVMR_INTERFACE>() - 8usize];
    ["Offset of field: tagVBVMR_INTERFACE::VBVMR_Login"]
        [::std::mem::offset_of!(tagVBVMR_INTERFACE, VBVMR_Login) - 0usize];
    ["Offset of field: tagVBVMR_INTERFACE::VBVMR_Logout"]
        [::std::mem::offset_of!(tagVBVMR_INTERFACE, VBVMR_Logout) - 8usize];
    ["Offset of field: tagVBVMR_INTERFACE::VBVMR_RunVoicemeeter"]
        [::std::mem::offset_of!(tagVBVMR_INTERFACE, VBVMR_RunVoicemeeter) - 16usize];
    ["Offset of field: tagVBVMR_INTERFACE::VBVMR_GetVoicemeeterType"]
        [::std::mem::offset_of!(tagVBVMR_INTERFACE, VBVMR_GetVoicemeeterType) - 24usize];
    ["Offset of field: tagVBVMR_INTERFACE::VBVMR_GetVoicemeeterVersion"]
        [::std::mem::offset_of!(tagVBVMR_INTERFACE, VBVMR_GetVoicemeeterVersion) - 32usize];
    ["Offset of field: tagVBVMR_INTERFACE::VBVMR_IsParametersDirty"]
        [::std::mem::offset_of!(tagVBVMR_INTERFACE, VBVMR_IsParametersDirty) - 40usize];
    ["Offset of field: tagVBVMR_INTERFACE::VBVMR_GetParameterFloat"]
        [::std::mem::offset_of!(tagVBVMR_INTERFACE, VBVMR_GetParameterFloat) - 48usize];
    ["Offset of field: tagVBVMR_INTERFACE::VBVMR_GetParameterStringA"]
        [::std::mem::offset_of!(tagVBVMR_INTERFACE, VBVMR_GetParameterStringA) - 56usize];
    ["Offset of field: tagVBVMR_INTERFACE::VBVMR_GetParameterStringW"]
        [::std::mem::offset_of!(tagVBVMR_INTERFACE, VBVMR_GetParameterStringW) - 64usize];
    ["Offset of field: tagVBVMR_INTERFACE::VBVMR_GetLevel"]
        [::std::mem::offset_of!(tagVBVMR_INTERFACE, VBVMR_GetLevel) - 72usize];
    ["Offset of field: tagVBVMR_INTERFACE::VBVMR_GetMidiMessage"]
        [::std::mem::offset_of!(tagVBVMR_INTERFACE, VBVMR_GetMidiMessage) - 80usize];
    ["Offset of field: tagVBVMR_INTERFACE::VBVMR_SetParameterFloat"]
        [::std::mem::offset_of!(tagVBVMR_INTERFACE, VBVMR_SetParameterFloat) - 88usize];
    ["Offset of field: tagVBVMR_INTERFACE::VBVMR_SetParameters"]
        [::std::mem::offset_of!(tagVBVMR_INTERFACE, VBVMR_SetParameters) - 96usize];
    ["Offset of field: tagVBVMR_INTERFACE::VBVMR_SetParametersW"]
        [::std::mem::offset_of!(tagVBVMR_INTERFACE, VBVMR_SetParametersW) - 104usize];
    ["Offset of field: tagVBVMR_INTERFACE::VBVMR_SetParameterStringA"]
        [::std::mem::offset_of!(tagVBVMR_INTERFACE, VBVMR_SetParameterStringA) - 112usize];
    ["Offset of field: tagVBVMR_INTERFACE::VBVMR_SetParameterStringW"]
        [::std::mem::offset_of!(tagVBVMR_INTERFACE, VBVMR_SetParameterStringW) - 120usize];
    ["Offset of field: tagVBVMR_INTERFACE::VBVMR_Output_GetDeviceNumber"]
        [::std::mem::offset_of!(tagVBVMR_INTERFACE, VBVMR_Output_GetDeviceNumber) - 128usize];
    ["Offset of field: tagVBVMR_INTERFACE::VBVMR_Output_GetDeviceDescA"]
        [::std::mem::offset_of!(tagVBVMR_INTERFACE, VBVMR_Output_GetDeviceDescA) - 136usize];
    ["Offset of field: tagVBVMR_INTERFACE::VBVMR_Output_GetDeviceDescW"]
        [::std::mem::offset_of!(tagVBVMR_INTERFACE, VBVMR_Output_GetDeviceDescW) - 144usize];
    ["Offset of field: tagVBVMR_INTERFACE::VBVMR_Input_GetDeviceNumber"]
        [::std::mem::offset_of!(tagVBVMR_INTERFACE, VBVMR_Input_GetDeviceNumber) - 152usize];
    ["Offset of field: tagVBVMR_INTERFACE::VBVMR_Input_GetDeviceDescA"]
        [::std::mem::offset_of!(tagVBVMR_INTERFACE, VBVMR_Input_GetDeviceDescA) - 160usize];
    ["Offset of field: tagVBVMR_INTERFACE::VBVMR_Input_GetDeviceDescW"]
        [::std::mem::offset_of!(tagVBVMR_INTERFACE, VBVMR_Input_GetDeviceDescW) - 168usize];
    ["Offset of field: tagVBVMR_INTERFACE::VBVMR_AudioCallbackRegister"]
        [::std::mem::offset_of!(tagVBVMR_INTERFACE, VBVMR_AudioCallbackRegister) - 176usize];
    ["Offset of field: tagVBVMR_INTERFACE::VBVMR_AudioCallbackStart"]
        [::std::mem::offset_of!(tagVBVMR_INTERFACE, VBVMR_AudioCallbackStart) - 184usize];
    ["Offset of field: tagVBVMR_INTERFACE::VBVMR_AudioCallbackStop"]
        [::std::mem::offset_of!(tagVBVMR_INTERFACE, VBVMR_AudioCallbackStop) - 192usize];
    ["Offset of field: tagVBVMR_INTERFACE::VBVMR_AudioCallbackUnregister"]
        [::std::mem::offset_of!(tagVBVMR_INTERFACE, VBVMR_AudioCallbackUnregister) - 200usize];
    ["Offset of field: tagVBVMR_INTERFACE::VBVMR_MacroButton_IsDirty"]
        [::std::mem::offset_of!(tagVBVMR_INTERFACE, VBVMR_MacroButton_IsDirty) - 208usize];
    ["Offset of field: tagVBVMR_INTERFACE::VBVMR_MacroButton_GetStatus"]
        [::std::mem::offset_of!(tagVBVMR_INTERFACE, VBVMR_MacroButton_GetStatus) - 216usize];
    ["Offset of field: tagVBVMR_INTERFACE::VBVMR_MacroButton_SetStatus"]
        [::std::mem::offset_of!(tagVBVMR_INTERFACE, VBVMR_MacroButton_SetStatus) - 224usize];
};
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of tagVBAN_VMRT_PACKET"][::std::mem::size_of::<tagVBAN_VMRT_PACKET>() - 1384usize];
    ["Alignment of tagVBAN_VMRT_PACKET"][::std::mem::align_of::<tagVBAN_VMRT_PACKET>() - 1usize];
    ["Offset of field: tagVBAN_VMRT_PACKET::voicemeeterType"]
        [::std::mem::offset_of!(tagVBAN_VMRT_PACKET, voicemeeterType) - 0usize];
    ["Offset of field: tagVBAN_VMRT_PACKET::reserved"]
        [::std::mem::offset_of!(tagVBAN_VMRT_PACKET, reserved) - 1usize];
    ["Offset of field: tagVBAN_VMRT_PACKET::buffersize"]
        [::std::mem::offset_of!(tagVBAN_VMRT_PACKET, buffersize) - 2usize];
    ["Offset of field: tagVBAN_VMRT_PACKET::voicemeeterVersion"]
        [::std::mem::offset_of!(tagVBAN_VMRT_PACKET, voicemeeterVersion) - 4usize];
    ["Offset of field: tagVBAN_VMRT_PACKET::optionBits"]
        [::std::mem::offset_of!(tagVBAN_VMRT_PACKET, optionBits) - 8usize];
    ["Offset of field: tagVBAN_VMRT_PACKET::samplerate"]
        [::std::mem::offset_of!(tagVBAN_VMRT_PACKET, samplerate) - 12usize];
    ["Offset of field: tagVBAN_VMRT_PACKET::inputLeveldB100"]
        [::std::mem::offset_of!(tagVBAN_VMRT_PACKET, inputLeveldB100) - 16usize];
    ["Offset of field: tagVBAN_VMRT_PACKET::outputLeveldB100"]
        [::std::mem::offset_of!(tagVBAN_VMRT_PACKET, outputLeveldB100) - 84usize];
    ["Offset of field: tagVBAN_VMRT_PACKET::TransportBit"]
        [::std::mem::offset_of!(tagVBAN_VMRT_PACKET, TransportBit) - 212usize];
    ["Offset of field: tagVBAN_VMRT_PACKET::stripState"]
        [::std::mem::offset_of!(tagVBAN_VMRT_PACKET, stripState) - 216usize];
    ["Offset of field: tagVBAN_VMRT_PACKET::busState"]
        [::std::mem::offset_of!(tagVBAN_VMRT_PACKET, busState) - 248usize];
    ["Offset of field: tagVBAN_VMRT_PACKET::stripGaindB100Layer1"]
        [::std::mem::offset_of!(tagVBAN_VMRT_PACKET, stripGaindB100Layer1) - 280usize];
    ["Offset of field: tagVBAN_VMRT_PACKET::stripGaindB100Layer2"]
        [::std::mem::offset_of!(tagVBAN_VMRT_PACKET, stripGaindB100Layer2) - 296usize];
    ["Offset of field: tagVBAN_VMRT_PACKET::stripGaindB100Layer3"]
        [::std::mem::offset_of!(tagVBAN_VMRT_PACKET, stripGaindB100Layer3) - 312usize];
    ["Offset of field: tagVBAN_VMRT_PACKET::stripGaindB100Layer4"]
        [::std::mem::offset_of!(tagVBAN_VMRT_PACKET, stripGaindB100Layer4) - 328usize];
    ["Offset of field: tagVBAN_VMRT_PACKET::stripGaindB100Layer5"]
        [::std::mem::offset_of!(tagVBAN_VMRT_PACKET, stripGaindB100Layer5) - 344usize];
    ["Offset of field: tagVBAN_VMRT_PACKET::stripGaindB100Layer6"]
        [::std::mem::offset_of!(tagVBAN_VMRT_PACKET, stripGaindB100Layer6) - 360usize];
    ["Offset of field: tagVBAN_VMRT_PACKET::stripGaindB100Layer7"]
        [::std::mem::offset_of!(tagVBAN_VMRT_PACKET, stripGaindB100Layer7) - 376usize];
    ["Offset of field: tagVBAN_VMRT_PACKET::stripGaindB100Layer8"]
        [::std::mem::offset_of!(tagVBAN_VMRT_PACKET, stripGaindB100Layer8) - 392usize];
    ["Offset of field: tagVBAN_VMRT_PACKET::busGaindB100"]
        [::std::mem::offset_of!(tagVBAN_VMRT_PACKET, busGaindB100) - 408usize];
    ["Offset of field: tagVBAN_VMRT_PACKET::stripLabelUTF8c60"]
        [::std::mem::offset_of!(tagVBAN_VMRT_PACKET, stripLabelUTF8c60) - 424usize];
    ["Offset of field: tagVBAN_VMRT_PACKET::busLabelUTF8c60"]
        [::std::mem::offset_of!(tagVBAN_VMRT_PACKET, busLabelUTF8c60) - 904usize];
};
...
pub struct VoicemeeterRemoteRaw {
    ...
    pub VBVMR_Login: unsafe extern "system" fn() -> ::std::os::raw::c_long,
    pub VBVMR_Logout: unsafe extern "system" fn() -> ::std::os::raw::c_long,
    pub VBVMR_RunVoicemeeter:
        unsafe extern "system" fn(vType: ::std::os::raw::c_long) -> ::std::os::raw::c_long,
    pub VBVMR_GetVoicemeeterType:
        unsafe extern "system" fn(pType: *mut ::std::os::raw::c_long) -> ::std::os::raw::c_long,
    pub VBVMR_GetVoicemeeterVersion:
        unsafe extern "system" fn(pVersion: *mut ::std::os::raw::c_long) -> ::std::os::raw::c_long,
    pub VBVMR_IsParametersDirty: unsafe extern "system" fn() -> ::std::os::raw::c_long,
    pub VBVMR_GetParameterFloat: unsafe extern "system" fn(
        szParamName: *mut ::std::os::raw::c_char,
        pValue: *mut f32,
    ) -> ::std::os::raw::c_long,
    pub VBVMR_GetParameterStringA: unsafe extern "system" fn(
        szParamName: *mut ::std::os::raw::c_char,
        szString: *mut ::std::os::raw::c_char,
    ) -> ::std::os::raw::c_long,
    pub VBVMR_GetParameterStringW: unsafe extern "system" fn(
        szParamName: *mut ::std::os::raw::c_char,
        wszString: *mut ::std::os::raw::c_ushort,
    ) -> ::std::os::raw::c_long,
    pub VBVMR_GetLevel: unsafe extern "system" fn(
        nType: ::std::os::raw::c_long,
        nuChannel: ::std::os::raw::c_long,
        pValue: *mut f32,
    ) -> ::std::os::raw::c_long,
    pub VBVMR_GetMidiMessage: unsafe extern "system" fn(
        pMIDIBuffer: *mut ::std::os::raw::c_uchar,
        nbByteMax: ::std::os::raw::c_long,
    ) -> ::std::os::raw::c_long,
    pub VBVMR_SetParameterFloat: unsafe extern "system" fn(
        szParamName: *mut ::std::os::raw::c_char,
        Value: f32,
    ) -> ::std::os::raw::c_long,
    pub VBVMR_SetParameterStringA: unsafe extern "system" fn(
        szParamName: *mut ::std::os::raw::c_char,
        szString: *mut ::std::os::raw::c_char,
    ) -> ::std::os::raw::c_long,
    pub VBVMR_SetParameterStringW: unsafe extern "system" fn(
        szParamName: *mut ::std::os::raw::c_char,
        wszString: *mut ::std::os::raw::c_ushort,
    ) -> ::std::os::raw::c_long,
    pub VBVMR_SetParameters: unsafe extern "system" fn(
        szParamScript: *mut ::std::os::raw::c_char,
    ) -> ::std::os::raw::c_long,
    pub VBVMR_SetParametersW: unsafe extern "system" fn(
        szParamScript: *mut ::std::os::raw::c_ushort,
    ) -> ::std::os::raw::c_long,
    pub VBVMR_Output_GetDeviceNumber: unsafe extern "system" fn() -> ::std::os::raw::c_long,
    pub VBVMR_Output_GetDeviceDescA: unsafe extern "system" fn(
        zindex: ::std::os::raw::c_long,
        nType: *mut ::std::os::raw::c_long,
        szDeviceName: *mut ::std::os::raw::c_char,
        szHardwareId: *mut ::std::os::raw::c_char,
    ) -> ::std::os::raw::c_long,
    pub VBVMR_Output_GetDeviceDescW: unsafe extern "system" fn(
        zindex: ::std::os::raw::c_long,
        nType: *mut ::std::os::raw::c_long,
        wszDeviceName: *mut ::std::os::raw::c_ushort,
        wszHardwareId: *mut ::std::os::raw::c_ushort,
    ) -> ::std::os::raw::c_long,
    pub VBVMR_Input_GetDeviceNumber: unsafe extern "system" fn() -> ::std::os::raw::c_long,
    pub VBVMR_Input_GetDeviceDescA: unsafe extern "system" fn(
        zindex: ::std::os::raw::c_long,
        nType: *mut ::std::os::raw::c_long,
        szDeviceName: *mut ::std::os::raw::c_char,
        szHardwareId: *mut ::std::os::raw::c_char,
    ) -> ::std::os::raw::c_long,
    pub VBVMR_Input_GetDeviceDescW: unsafe extern "system" fn(
        zindex: ::std::os::raw::c_long,
        nType: *mut ::std::os::raw::c_long,
        wszDeviceName: *mut ::std::os::raw::c_ushort,
        wszHardwareId: *mut ::std::os::raw::c_ushort,
    ) -> ::std::os::raw::c_long,
    pub VBVMR_AudioCallbackRegister: unsafe extern "system" fn(
        mode: ::std::os::raw::c_long,
        pCallback: T_VBVMR_VBAUDIOCALLBACK,
        lpUser: *mut ::std::os::raw::c_void,
        szClientName: *mut ::std::os::raw::c_char,
    ) -> ::std::os::raw::c_long,
    pub VBVMR_AudioCallbackStart: unsafe extern "system" fn() -> ::std::os::raw::c_long,
    pub VBVMR_AudioCallbackStop: unsafe extern "system" fn() -> ::std::os::raw::c_long,
    pub VBVMR_AudioCallbackUnregister: unsafe extern "system" fn() -> ::std::os::raw::c_long,
    pub VBVMR_MacroButton_IsDirty: unsafe extern "system" fn() -> ::std::os::raw::c_long,
    pub VBVMR_MacroButton_GetStatus: unsafe extern "system" fn(
        nuLogicalButton: ::std::os::raw::c_long,
        pValue: *mut f32,
        bitmode: ::std::os::raw::c_long,
    ) -> ::std::os::raw::c_long,
    pub VBVMR_MacroButton_SetStatus: unsafe extern "system" fn(
        nuLogicalButton: ::std::os::raw::c_long,
        fValue: f32,
        bitmode: ::std::os::raw::c_long,
    ) -> ::std::os::raw::c_long,
